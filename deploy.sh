...
if [ ! -f "terraform/terraform.tfvars" ]; then
    ...
    echo "   - prompt_log_s3_uri (optional, for prompt logging viewer)"
    echo ""
...
PROMPT_LOG_S3_URI=$(terraform -chdir=terraform output -raw prompt_log_s3_uri)
...
PROMPT_LOG_S3_URI=${PROMPT_LOG_S3_URI}
EOF
